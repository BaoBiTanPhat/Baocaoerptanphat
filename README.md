...
| **Phiên bản mã nguồn** | `V1.00.371` (đo 13/09/2026 tại `src/lib/version.ts`) *(mốc cũ của dòng này: `V1.00.369`, đo 06/09/2026)* |
| **Phiên bản đã phát hành lên vận hành** | `V1.00.370` — phát hành **07/09/2026**, nhánh `main`. Kiểm chứng độc lập ngay sau khi phát hành: trang thật trả đúng `V1.00.370` · **7/7 tuyến trọng yếu trả 200** · và **lần đầu tiên kho riêng với máy vận hành cùng MỘT bản mã nguồn**. *(Mốc cũ của dòng này: V1.00.369 ngày 04/09/2026; trước nữa là V1.00.355 ngày 23/08/2026.)* |
| **Mốc phiên bản hiện tại** | Mã nguồn **`V1.00.371`** · máy vận hành **`V1.00.370`** — ⚠️ **lệch đúng MỘT đợt, có chủ đích, KHÔNG phải sự cố.** `V1.00.371` mới là **ứng viên phát hành** (gói nghiệp vụ M1→M3 + bản in báo giá, đóng gói 11/09/2026), **chưa triển khai** vì đang chờ Chủ dự án duyệt bố cục bản in. 🆚 **Khác hẳn tình huống 06/09**, khi hai nơi **cùng số mà khác mã nguồn** nên nhìn vào tưởng đã đồng bộ; lần này **số khác nhau đúng bằng phần còn thiếu**, nhìn là thấy ngay. |
| **Ngày bắt đầu** | 18/01/2026 |
| **Phát hành lên vận hành thật** | 07/09/2026 — **V1.00.370** (hội tụ ba nơi sau đợt chuyển kho) · 04/09 — V1.00.369 · 23/08 — V1.00.355 (tách Biểu Mẫu) + V1.00.353 + V1.00.354 · 22/08 — V1.00.351 + V1.00.352 · 17/08 — V1.00.338–344 · 11/08 — V1.00.337 |
| **Cập nhật báo cáo này** | **13/09/2026** *(bản 06/09 đã lỗi thời: thiếu hẳn đợt phát hành 07/09 và đợt đóng gói 11/09)* |
...
| **Trạng thái** | Máy vận hành đang chạy **V1.00.370** (phát hành 07/09/2026 — trang thật trả đúng số này, 7/7 tuyến trọng yếu trả 200).<br>✅ **Đợt 07/09 đã hội tụ hoàn toàn** — lỗ hổng "cùng số nhưng khác mã nguồn" nêu ở bản 06/09 **đã đóng**.<br>⏳ **Đang chờ Chủ dự án — đúng một câu trả lời:** duyệt **bố cục bản in Báo Giá**. Gói `V1.00.371` (nghiệp vụ M1→M3 + bản in báo giá) đã đóng gói 11/09/2026 nhưng **chưa triển khai**; câu hỏi triển khai **cố ý chưa hỏi**, đúng chỉ thị của Chủ dự án là mỗi cổng chỉ hỏi một câu.<br>🕰️ *Mốc lịch sử: V1.00.337 go-live · V1.00.355 (23/08) · V1.00.369 (04/09).* |
...
>
> 📦 **ĐÓNG GÓI V1.00.371 — hoàn tất chuỗi nghiệp vụ Bán Hàng M1→M3 + làm lại bản in Báo Giá (11/09/2026). CHƯA TRIỂN KHAI — đang chờ Chủ dự án duyệt bố cục bản in.** **Việc lớn nhất: bản in Báo Giá nay đưa khách được.** Trước đó tờ in ra chỉ ghi một **mã nội bộ** thay cho **tên khách hàng**, lại **không có** thông tin pháp nhân công ty, **không có** phần thuế, **không có** khối ký — nên nhân viên kinh doanh phải gõ lại báo giá bằng Word mới gửi khách được. Nguyên nhân gốc tìm ra: phần lấy dữ liệu cho bản in **không hề nối sang danh mục khách hàng**, nên bản in không có tên khách trong tay; nghịch lý là chính màn hình Báo Giá **vẫn đang hiển thị đúng tên khách**. Nay bản in dựng theo **đúng mẫu Chủ dự án đã duyệt**, và thông tin pháp nhân gom về **một nguồn duy nhất** (trước bị chép tay ở ba nơi). 🛡️ **Gỡ hẳn chữ nội bộ khỏi tờ giấy gửi khách:** trước đây mọi bản in đều đóng nhãn trạng thái quy trình lên đầu trang — khách có thể nhận tờ ghi *«Từ chối»* mà không hiểu là gì. Nay trạng thái **chỉ quyết định được gửi khách hay không**; bản nháp và bản hết hiệu lực bị **đóng dấu chìm chéo trang**, và trạng thái lạ cũng bị đóng dấu (**mặc định là chặn**, không mặc định cho gửi). ⚠️ **Bốn thứ cố ý KHÔNG bịa:** suất thuế (mẫu của Chủ dự án ghi *«nếu áp dụng»*, không có số; trong hệ thống đang có **hai số chọi nhau** nên chọn bên nào cũng là đoán) · điều khoản thanh toán · tài khoản ngân hàng · tên người ký. ✅ **Chạy thật cả chuỗi, không chỉ đọc mã:** lập báo giá → gửi duyệt → duyệt → sinh đơn hàng → xác nhận đơn, **có bằng chứng ở tầng dữ liệu cho từng chặng**. Chính vì chạy thật mới lộ **hai lỗ chặn** đã vá: hàm gửi duyệt **không nơi nào gọi tới** (nút có mà đường đi không có), và hộp thoại tạo đơn **ghi đè thừa** lên báo giá đã khoá. Kèm: cảnh báo vàng khi gửi email/thông báo thất bại **đã nhìn thấy bằng mắt trên trình duyệt** (trước đây báo xanh giả dù chưa gửi được) · ô Ghi chú lưu thật · tạo nhanh sản phẩm ngay trong báo giá (khoá đúng khách, chống trùng tên). **Số đo:** bộ kiểm bản in **60/60 điểm kiểm, 0 trượt**. 📄 **Bản in để Chủ dự án xem bằng mắt:** năm bản minh hoạ (1 dòng · 5 dòng · 20 dòng · 30 dòng · bản nháp có dấu chìm), mỗi bản kèm PDF khổ A4 và ảnh chụp — **dựng lại trọn bộ từ đúng bản mã nguồn phát hành**, bộ cũ đã huỷ hiệu lực. Bản dựng từ dữ liệu thật **cố ý không đưa vào kho công khai** vì chứa tên và liên hệ khách thật.
>
> 🚀 **ĐÃ PHÁT HÀNH V1.00.370 — hội tụ ba nơi sau đợt chuyển kho (07/09/2026).** Đợt này đóng lại lỗ hổng mà bản báo cáo 06/09 đã nêu: **cùng một số phiên bản nhưng khác mã nguồn**, nên nhìn vào tưởng đã đồng bộ trong khi máy vận hành đang chạy bản cũ hơn. 🔧 **Sự cố phải xử lý trước:** Chủ dự án chuyển các kho từ tài khoản cá nhân sang tài khoản tổ chức, và điều đó **làm đứt dây chuyền phát hành** theo một cách rất dễ bỏ sót — đường truy cập **kiểu web tự động chuyển hướng** sang địa chỉ mới nên máy của Chủ dự án vẫn dùng bình thường, **che mất lỗi**; nhưng đường truy cập **kiểu khoá máy** thì **không chuyển hướng**, mà máy vận hành lại dùng đúng đường đó ⇒ lệnh kéo mã **chết ngay**. Cô lập được nguyên nhân thật: **không phải sai địa chỉ**, mà là **mất quyền đọc** sau khi kho đổi chủ sở hữu — và **chính sách ở cấp tổ chức** đã tắt loại khoá đó trên toàn bộ kho, nên trang cài đặt của từng kho **không có nút bật lại**. Chủ dự án bật lại ở cấp tổ chức là thông. **Bài học đã ghi thẳng vào tài liệu vận hành** để lần sau không mất thời gian dò lại. ✅ **Kiểm chứng độc lập sau khi phát hành, không tin mỗi màn hình:** cổng kiểm định danh phát hành **4 đạt / 0 trượt** với **cùng một bản mã nguồn ở cả hai nơi** — lần đầu tiên đạt được điều này · trang thật trả đúng `V1.00.370` · **7/7 tuyến trọng yếu trả 200** · bản kê triển khai tự đối chứng và xác nhận **không có thay đổi cấu trúc dữ liệu** nên **không cần bước nạp dữ liệu**. ⭐ **Điểm đáng chú ý:** hai bản vá công cụ của **chính đợt này** đã tự bảo vệ lần triển khai của chúng — nhật ký in ra dòng kiểm tuyến **bắt buộc** rồi báo *«4/4 tuyến trọng yếu đều lành»*; bản công cụ cũ **không hề in như vậy**, nó chỉ in một dòng trạng thái rồi đi tiếp.
>
